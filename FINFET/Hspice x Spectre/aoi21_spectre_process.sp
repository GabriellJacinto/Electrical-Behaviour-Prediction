...
parameters vcc=0.7 wf_n=4.3720 wf_p=4.8108
parameters sigma=3 variation=0.05
...
statistics 
{
	process
	{
	    vary wf_n dist=gauss std="(wf_n*variation)/sigma" percent=no
	    vary wf_p dist=gauss std="(wf_p*variation)/sigma" percent=no
	}
}
...
mc1 montecarlo variations=process seed=1234 numruns=2000 donominal=yes
{
