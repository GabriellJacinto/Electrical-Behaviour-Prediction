...
simulator lang = spice
	...
	.measure tran TP_HL_1_A_0 trig v(a1) val='0.5*supply' fall=3 targ v(cout) val='0.5*supply' fall=5

	.measure tran TP_LH_0_1_B trig v(b1) val='0.5*supply' rise=2 targ v(cout) val='0.5*supply' rise=7
	.measure tran TP_HL_0_1_B trig v(b1) val='0.5*supply' fall=3 targ v(cout) val='0.5*supply' fall=7
	.measure tran TP_LH_1_0_B trig v(b1) val='0.5*supply' rise=3 targ v(cout) val='0.5*supply' rise=8
	.measure tran TP_HL_1_0_B trig v(b1) val='0.5*supply' fall=4 targ v(cout) val='0.5*supply' fall=8
*****
...
* tipo de simulação
simulator lang=spectre
mc1 montecarlo variations=process seed=12345 numruns=2000 donominal=yes
{
	tran1 tran start=0 stop=54n method=trap
}
